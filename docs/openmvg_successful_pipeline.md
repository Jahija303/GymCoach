...
~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_SfMInit_ImageListing \
  -i ~/schade/openMVG_Build/images2 \
  -o ~/schade/openMVG_Build/output2/matches \
...
~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_ComputeFeatures \
  -i ~/schade/openMVG_Build/output2/matches/sfm_data.json \
  -o ~/schade/openMVG_Build/output2/matches \
  -m AKAZE_FLOAT
```
...
~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_PairGenerator \
  -i ~/schade/openMVG_Build/output2/matches/sfm_data.json \
  -o ~/schade/openMVG_Build/output2/matches/pairs.bin
```
...
~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_ComputeMatches \
  -i ~/schade/openMVG_Build/output2/matches/sfm_data.json \
  -o ~/schade/openMVG_Build/output2/matches/matches.putative.bin \
  -p ~/schade/openMVG_Build/output2/matches/pairs.bin
```
...
~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_GeometricFilter \
  -i ~/schade/openMVG_Build/output2/matches/sfm_data.json \
  -m ~/schade/openMVG_Build/output2/matches/matches.putative.bin \
  -o ~/schade/openMVG_Build/output2/matches/matches.f.bin
```
...
**Command**:
```bash
mkdir -p ~/schade/openMVG_Build/output2/reconstruction_sequential

~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_SfM \
  -i ~/schade/openMVG_Build/output2/matches/sfm_data.json \
  -m ~/schade/openMVG_Build/output2/matches \
  -o ~/schade/openMVG_Build/output2/reconstruction_sequential/sfm_data.bin
```
...
~/schade/openMVG_Build/Linux-x86_64-RELEASE/openMVG_main_ComputeSfM_DataColor \
  -i ~/schade/openMVG_Build/output2/reconstruction_sequential/sfm_data.bin/sfm_data.bin \
  -o ~/schade/openMVG_Build/output2/reconstruction_sequential/colorized.ply
```
